...
# ---------- GLOBAL CSS OVERRIDES & FLOATING FIX ----------
st.markdown("""
    <style>
    ...
    /* CRITICAL SCREEN FIX: Pin the element globally so scrolling other sessions 
       doesn't push Wayne-AI away.
    */
    div#wayne-global-anchor {
    ...
    div#wayne-global-anchor iframe {
        width: 100% !important;
...
# -------------------------------------------------------------------------
# ---------- CHAT PARAMETER LINK PROCESSING LAYER ----------
# -------------------------------------------------------------------------
...
# Build HTML dialogue elements dynamically
chat_bubbles_html = ""
...
# ---------- RENDER FLOATING CORE (TOP LEVEL LAYER) ----------
# Wrapping this inside a custom div id allows us to target it precisely with global fixed positioning
st.markdown('<div id="wayne-global-anchor">', unsafe_allow_html=True)

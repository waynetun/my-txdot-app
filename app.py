...
st.markdown("""
    ...
    /* CRITICAL FIX: This targets the outer iframe container generated by Streamlit 
       and breaks it out of the scrolling page layout flow, pinning it perfectly 
       to the window layer—just like the main app toolbar!
    */
...
# ---------- RENDER THE FLOATING ASSISTANT INTERFACE ----------
# This component now operates outside columns, allowing global layout targeting
st.components.v1.html(f"""
    <div id="wayne-app-root" style="position: fixed; bottom: 0; right: 0; width: 100%; height: 100%; display: flex; flex-direction: column; justify-content: flex-end; align-items: flex-end; font-family: system-ui, -apple-system, BlinkMacSystemFont, sans-serif; pointer-events: none; padding: 10px; box-sizing: border-box;">
    ...
    <script>
        ...
        // Sync local panel state tracking from global pipeline context memory
        ...
        // Run initial structural generation display rendering routines
